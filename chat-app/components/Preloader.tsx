            ...
            <footer className="absolute bottom-6 left-0 right-0 z-10">
                <div className="mx-auto flex w-full max-w-lg flex-col items-center justify-center gap-2 px-6 text-center">
                    <span className="text-[11px] text-muted-foreground font-poppins">
                        Got an idea or a vibe to improve? Drop a note at <a className="underline underline-offset-2 hover:text-foreground transition-colors" href="mailto:feedback@nullchat.tech">feedback@nullchat.tech</a>
                    </span>
                    <span className="text-[11px] text-muted-foreground font-poppins">
                        Need a hand right now? Reach us at <a className="underline underline-offset-2 hover:text-foreground transition-colors" href="mailto:support@nullchat.tech">support@nullchat.tech</a>
                    </span>
                </div>
            </footer>
